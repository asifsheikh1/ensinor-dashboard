        ...
        >
          ...
          <div>
            <label htmlFor="tenantName" className={labelClassNames}>
              Your Position <span className="text-red-500 text-lg">*</span>
            </label>
            <input
              type="text"
              id="tenantName"
          ...
          <div>
            <label htmlFor="rent" className={labelClassNames}>
              Job Responsibilities <span className="text-red-500 text-lg">*</span>
            </label>
            <input
              type="text"
              id="rent"
